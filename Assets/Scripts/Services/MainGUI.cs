...
public class MainGUI : MonoBehaviour
{
    ...
    {
        Social.ReportProgress(GPGSIds.achievement_primera_vez, 100.0f, (bool success) =>
        {
    ...
    void OnGUI()
    {
        ...
        GUI.Label(new Rect(5, 5, Screen.width, Screen.height * 0.25f),
                  mStatusText);

        Rect buttonRect = new Rect(0.10f * Screen.width, 0.05f * Screen.height,
